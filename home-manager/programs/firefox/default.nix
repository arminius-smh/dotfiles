...
let
  cfg = config.cave.programs.firefox;
in
{
  options.cave = {
    programs.firefox.enable = lib.mkEnableOption "enable programs.firefox config";
  };
    ...
    programs.firefox = {
      ...
      profiles.armin = {
          ...
          settings = [
            {
              ...
              bookmarks = [
                {
                  name = "Homepage";
                  url = config.private.ips.homepage;
                }
                {
                  name = "Syncthing";
                ...
                config.private.browser.bookmarks
              ];
            }
          ];
        };
        ...
        settings = {
          ...
          "browser.startup.homepage" = config.private.ips.homepage;
